...
function DetailSidebar({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Sidebar header */}
      <div className="flex items-center px-6 h-8 border-b border-zd-text flex-shrink-0">
        <div className="flex items-center gap-2">
          <TypeIcon />
          <Link href={`/demo/release/${release.contractAddress}`} className="font-display text-sm tracking-tight hover:text-zd-text-secondary transition-colors duration-100">
            {releaseName(release)}
          </Link>
        </div>
      </div>
        ...
        <div className="p-6">
          ...
          <div className="mt-4 border border-zd-text bg-zd-surface group/preview">
            <div className="flex items-center gap-2 px-3 py-2 border-b border-zd-text">
              <TypeIcon />
              <span className="text-xs font-mono text-zd-text-muted truncate">{releaseName(release)}</span>
            </div>
          ...
          <button
            onClick={(e) => e.stopPropagation()}
            className="w-full border border-dotted border-zd-text bg-transparent text-zd-text hover:bg-zd-surface-hover transition-colors duration-100 font-mono text-xs py-1.5 px-4 mt-4"
          >
            Collect
          </button>
        </div>
        ...
        <div className="border-t border-zd-text px-6 pt-3">
          ...
          <div className="mt-2 space-y-1.5">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-mono text-xs text-zd-text-muted">{releaseName(release)}</span>
            </div>
            <div className="flex justify-between">
