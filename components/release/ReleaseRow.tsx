...
export function ReleaseRow({ address, metadata, creatorAddress, creatorName }: ReleaseRowProps) {
  ...
  return (
    <Link
      ...
      className="grid grid-cols-[40px_1fr_140px_140px_80px] items-center h-12 px-3 border-b border-zd-border last:border-b-0 cursor-pointer transition-colors duration-150 hover:bg-zd-surface-hover group"
    >
...
export function ReleaseRowSkeleton() {
  return (
    <div className="grid grid-cols-[40px_1fr_140px_140px_80px] items-center h-12 px-3 border-b border-zd-border last:border-b-0 animate-pulse">
